...
def tui_help_text(app: "ToolkitTuiApp") -> None:
    ...
    lines = [
        ...
        "  list-skills                   列出本机 Skills",
        "  export-skills                 导出 standalone Skills Bundle",
        "  list-skill-bundles            列出 standalone Skills Bundle",
        "  import-skill-bundle           导入单个 standalone Skills Bundle",
        "  import-skill-bundles          批量导入 standalone Skills Bundle",
        ...
        f"  {app._cli_preview(('export-skills',))}",
        f"  {app._cli_preview(('import-skill-bundle', './codex_bundles/Work-Laptop/skills/all/<timestamp>'))}",
